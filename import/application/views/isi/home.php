	            ...
	            <div class="row justify-content-between">
	                <div class="col-xl-8 col-lg-8 d-flex align-items-center">
	                    <div class="main_title_1">
	                        <h3>Gua Sunyaragi Cirebon</h3>
	                        <p align="justify">Gua Sunyaragi atau Taman Sari Sunyaragi merupakan sebuah situs bersejarah dan tempat wisata di Kota Cirebon yang dahulunya digunakan oleh para sultan di masa lalu untuk bermeditasi dan mengatur strategi perlawanan terhadap penjajahan Belanda.</p>
	                        <p><em>- Let's explore Sunyaragi cave !</em></p>
	                    </div>
	                </div>
	                <!-- /col -->
	                <div class="col-xl-4 col-lg-4">
	                    <img src="<?php echo base_url();?>assets/cirebon.png" alt="">
	                    </div>
	                    <!-- /Wizard container -->
	                </div>
	                <!-- /col -->
