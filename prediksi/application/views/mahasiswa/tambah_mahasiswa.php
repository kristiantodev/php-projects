            ...
            <div class="card-body">
              ...
              <form method="post" action="<?= base_url('mahasiswa/add'); ?>" >
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukan Nama Mahasiswa" value="<?= set_value('nama') ?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="angkatan" name="angkatan" placeholder="Masukan Angkatan" value="<?= set_value('angkatan') ?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="telephone" name="telephone" placeholder="Masukan Telephone " value="<?= set_value('telephone') ?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="dosen_wali" name="dosen_wali" placeholder="Masukan Dosen Wali" value="<?= set_value('dosen_wali') ?>">
