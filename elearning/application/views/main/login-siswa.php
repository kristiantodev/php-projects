...
<body class="bg-silver-300">
    <div class="content" style="margin-top: 100px;">
        <form id="login-form" action="<?php echo base_url('Auth/aksi_login2'); ?>" method="post">
            ...
            <p align="center" style="margin-top:-20px;">Login Siswa</p>
            <div class="form-group">
                <div class="input-group-icon right">
                    <div class="input-icon"><i class="fa fa-pencil"></i></div>
                    <input class="form-control" type="date" name="tgl_lahir" placeholder="Tanggal Lahir" autocomplete="off">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group-icon right">
                    <div class="input-icon"><i class="fa fa-lock font-16"></i></div>
                    <input class="form-control" type="text" name="no_induk" placeholder="No Induk">
                </div>
            </div>
            <hr>  
            <div class="form-group">
