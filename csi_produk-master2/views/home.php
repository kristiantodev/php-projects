      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-5 col-lg-6 order-md-2">
            ...
            <!-- Image -->
            <img src="<?=base_url()?>assets/landkit/survey.png" class="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0 aos-init aos-animate" alt="..." data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-12 col-md-7 col-lg-6 order-md-1 aos-init aos-animate" data-aos="fade-up">
            ...
            <h1 class="display-3 text-center text-md-left">
              <span class="text-primary">SISTEM KEPUASAN PELANGGAN TERHADAP LAYANAN DAN PRODUK PD. PADI KAPAS INDRAMAYU</span>
            </h1>
            ...
            <div class="text-center text-md-left">
              <a href="#" class="btn btn-primary lift" data-toggle="modal" data-target="#takeQuestionnaire">
                Isi Kuesioner
              </a>
            </div>
