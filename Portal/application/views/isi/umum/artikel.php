  ...
  <div class="main-content">
    ...
    <section>
      <div class="container">
        ...
        <center>
          <h3 class="text-uppercase mt-0 line-height-1"><b><i class="fa fa-list text-theme-colored font-24 mt-5"></i>&nbsp; Berita<span class="text-theme-colored"> Kampus</b></span></h3>
...
foreach ($results as $artikel): ?>
              ...
              <?php if ( $artikel->foto == "default.jpg"){ ?>

                   <?php }else{ ?>
                <div class="thumb"> <br><img alt="featured project" height="165" src="<?php echo base_url('assets/images/artikel/'.$artikel->foto) ?>" class="img-fullwidth"></div>
              <?php } ?>
              </div>
              <div class="col-sm-6 col-md-8">
                <p align="justify">
<h4 class="entry-title text-white m-0"><a href="<?php echo base_url().'artikel/'.$artikel->slug;?>"><font color="#21a0f0"><p align="justify"><?php echo $artikel->judul_artikel ?></p></font></a></h4>
                </p>
                <ul class="review_text list-inline">
                  <li>
                  <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-calendar mr-5 text-theme-colored"></i> &nbsp;<?php echo Date('d M Y H:m', strtotime($artikel->tgl_post)).' WIB' ?></span>                       
                  <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-user mr-5 text-theme-colored"></i> &nbsp;<?php echo $artikel->author ?></span>
                  </li>

                </ul>
                <p><?php echo limit_words($artikel->isi,25);?> .....</p>
                <a href="<?php echo base_url().'artikel/'.$artikel->slug;?>" class="btn-read-more">Baca Artikel</a>
                </div>
            </div>
            <hr>
            <?php endforeach; ?>
