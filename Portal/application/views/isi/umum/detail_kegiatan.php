      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-9 blog-pull-left">
            ...
            <h3 class="name mt-0"><?php echo $b['judul_kegiatan'];?> </h3>
             
                <?php if ( $b['foto'] == "default.jpg"){ ?>

                   <?php }else{ ?>
              <div class="thumb"><center><img src="<?php echo base_url().'assets/images/kegiatan/'.$b['foto'];?>" width="700" alt=""></center></div>
          ...
          <div class="col-sm-12 col-md-3">
            <div class="sidebar sidebar-left">
              ...
              <div class="widget">
                <h4 class="widget-title line-bottom"><b><i class="fa fa-tags"></i>&nbsp;Baca : <span class="text-theme-color-2">Kegiatan Lainnya</span></b></h4>
         ...
         foreach ($kegiatanku as $a): ?>
                  <article class="post media-post clearfix pb-0 mb-10">
                    <a class="post-thumb" href="<?php echo base_url().'kegiatan/'.$a->slug;?>"><img src="<?php echo base_url('assets/images/kegiatan/'.$a->foto) ?>" width='75' height='75' alt=""></a>
                    <div class="post-right">
                      <h4 class="post-title mt-0"><a href="<?php echo base_url().'kegiatan/'.$a->slug;?>"><?php echo limit_words($a->judul_kegiatan,8);?> ...</a></h4>
                    </div>
                  </article>
            <?php endforeach; ?>   
                </div>
