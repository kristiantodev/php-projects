 <!-- Start main-content -->
  <div class="main-content">
    ...
    <section id="team">
      ...
      <!-- Portfolio Filter -->
              <center>
          <h3 class="text-uppercase mt-0 line-height-1"><b><i class="fa fa-list text-theme-colored font-24 mt-5"></i>&nbsp; Galeri<span class="text-theme-colored"> Foto</b></span></h3>
          ...
          foreach ($galleryku as $g): ?>
                <div class="col-sm-6 col-md-3">
                  ...
                  <a data-rel="prettyPhoto[gallery1]" title="<?php echo $g->ket ?>" href="<?php echo base_url('assets/images/gallery/'.$g->foto) ?>">
                    <div class="thumb"> <img src="<?php echo base_url('assets/images/gallery/'.$g->foto) ?>" width='360' height='170' class="img-fullwidth">
                    ...
                    <center><?php echo Date('d M Y H:m', strtotime($g->tgl_input)).' WIB' ?> </center>
                      <p><center><?php echo $g->ket ?></center></p>
                     </div>
                  </div>
                </div>
