        ...
        <div class="col-12">          
          ...
          <div class="box box-solid bg-dark2">
            <div class="box-header">
              <h5 class="box-title">Form Edit Materi Download</h5>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php base_url('page/dosen/materi/edit') ?>" method="post" enctype="multipart/form-data">
               <input type="hidden" name="id_materi" value="<?php echo $materi->id_materi?>"/>
               <input type="hidden" name="id_user" value="<?php echo $materi->id_user?>"/>
               <div class="form-group">
                            <h5>Judul Materi<span class="text-danger">*</span></h5>
                            <div class="controls">
                                <input type="text" value="<?php echo $materi->nm_materi?>" name="nm_materi" class="form-control <?php echo form_error('nm_materi') ? 'is-invalid':'' ?>"> </div>
          ...
          <div class="col-md-4">
            ...
            <select name="kode_mk" id="select" class="form-control <?php echo form_error('kode_mk') ? 'is-invalid':'' ?>">
                  ...
                  <?php foreach ($matkulku as $matkul): ?>
                    <option value="<?php echo $matkul->kode_mk ?>" 
                              <?php
                              if ($materi->kode_mk == $matkul->kode_mk){
                              echo "selected";
                                    }else{
                              echo "";
                              }
          ...
          <div class="col-md-4">
           <h5>Pertemuan Ke-<span class="text-danger">*</span></h5>
            <input type="text" value="<?php echo $materi->pertemuan_ke?>" name="pertemuan_ke" class="form-control">
          </div>
          <div class="col-md-4">
            <h5>Status<span class="text-danger">*</span></h5>
           <div class="demo-radio-button">
           <?php if ($materi->status == "Publish"){ ?>
...
<?php }else{ ?> 
          ...
          <label for="radio_30">Publish Umum</label>         
          <input name="status" value="Privasi" type="radio" id="radio_39" class="with-gap radio-col-navy" checked/>
          <label for="radio_39">Privasi</label>
<?php } ?>
        </div>
          </div>
        ...
        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" value="<?php echo $materi->link_materi?>" name="link_materi" class="form-control"> </div>
                        </div>
        ...
        <input type="hidden" name="old_image" value="<?php echo $materi->file?>"/>
