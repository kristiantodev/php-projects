  ...
  <div class="content-header">
    <div class="d-flex align-items-center">
      <div class="mr-auto">
        <h3 class="page-title">Daftar Foto Gallery Dosen</h3>
      ...
      <a href="<?php echo site_url();?>page/dosen/gallery/tambah" type="button" class="btn btn-outline btn-rounded btn-primary mb-5"><i class="fa fa-upload"></i> Upload Foto</a>
      </div>
    </div>
    ...
    <div class="col-12">
        ...
        <div class="ribbon ribbon-bookmark ribbon-right bg-primary"><i class="fa  fa-file-photo-o"></i>&nbsp;&nbsp;<b> Daftar Foto Gallery - <?php echo $myuser->nm_user?></b></div>           
               ...
               <td align="center"><a href="<?php echo base_url('assets/images/gallery/'.$gallery->foto) ?>" data-toggle="lightbox" data-gallery="multiimages" data-title="Keterangan Foto : <?php echo $gallery->ket ?>">
                 <img src="<?php echo base_url('assets/images/gallery/'.$gallery->foto) ?>" width="95" height="50" class="all studio" alt="gallery" /></a>
                  ...
                  <td scope="row"><?php echo $gallery->ket ?></td>
                     ...
                     <a href="<?php echo site_url('page/dosen/gallery/edit/'.$gallery->id_gallery) ?>" data-toggle="tooltip" class="btn btn-info btn-wth-icon icon-wthot-bg btn-sm" data-original-title="Edit"><span class="icon-label"><i class="fa fa-pencil"></i> </span><span class="btn-text"></span></a>
                     <a onclick="deleteConfirm('<?php echo site_url('page/dosen/gallery/delete/'.$gallery->id_gallery) ?>')" href="#!" data-toggle="tooltip" class="btn btn-danger btn-wth-icon icon-wthot-bg btn-sm" data-original-title="Hapus"><span class="icon-label" data-toggle="modal" data-target="#modal-danger"><i class="fa fa-trash"></i> </span><span class="btn-text"></span></a>
                     </td>
