        ...
        <div class="col-12">          
          ...
          <div class="box box-solid bg-dark2">
            <div class="box-header">
              <h5 class="box-title">Post Pengumuman</h5>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php base_url('page/admin/pengumuman/tambah') ?>" method="post" enctype="multipart/form-data">
               <table width="96%">
               <tr>
               <td width="220">
                ...
                <div class="product-img">
                  ...
                  <div class="fileupload btn btn-outline btn-success">
                    <span><i class="ion-upload mr-5"></i>Upload Foto Pengumuman</span>
                    <input type="file" name="foto" class="upload">
                            ...
                            <div class="controls">
                                <input type="text" name="jdl_pengumuman" class="form-control <?php echo form_error('jdl_pengumuman') ? 'is-invalid':'' ?>"> </div>
