    ...
    <section class="content">
      <div class="row">
        <div class="col-12">          
          ...
          <div class="box box-solid bg-dark2">
            <div class="box-header">
              <h5 class="box-title">Form Edit User Login</h5>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php base_url('page/admin/user/edit') ?>" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id_user" value="<?php echo $user->id_user?>"/>
               <div class="form-group">
                            <h5>Username <span class="text-danger">*</span></h5>
                            <div class="controls">
                                <input type="text" value="<?php echo $user->username?>" name="username" class="form-control <?php echo form_error('username') ? 'is-invalid':'' ?>"> </div>
                ...
                <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="hidden" value="<?php echo $user->password?>" name="password" readonly class="form-control <?php echo form_error('password') ? 'is-invalid':'' ?>"> </div>
        ...
        <div class="row">
          ...
          <input name="level" value="Administrator" type="radio" id="radio_30" class="with-gap radio-col-navy" checked />
          ...
          <?php }else if($user->level == "BAAK") { ?>

          <input name="level" value="Administrator" type="radio" id="radio_30" class="with-gap radio-col-navy"/>
          <label for="radio_30">Administrator</label>      
          <input name="level" value="Kaprodi" type="radio" id="radio_39" class="with-gap radio-col-navy"/>
          <label for="radio_39">Kaprodi</label>
          <input name="level" value="BAAK" type="radio" id="radio_40" class="with-gap radio-col-navy"  checked />
          <label for="radio_40">BAAK</label>

           <?php }else{ ?>   
           <input name="level" value="Administrator" type="radio" id="radio_30" class="with-gap radio-col-navy"/>
          <label for="radio_30">Administrator</label>      
          <input name="level" value="Kaprodi" type="radio" id="radio_39" class="with-gap radio-col-navy" checked />
          <label for="radio_39">Kaprodi</label>
          <input name="level" value="BAAK" type="radio" id="radio_40" class="with-gap radio-col-navy"/>
          <label for="radio_40">BAAK</label>
           <?php } ?>
          ...
          <div class="col-md-9">
            ...
            <input type="text" name="nm_user" value="<?php echo $user->nm_user?>" class="form-control" required> </div>
          </div>
          ...
          <div class="col-md-3">
          <img src="<?php echo base_url('assets/images/user/'.$user->avatar) ?>" width='160' height='180' alt="">
          </div>
          <div class="col-md-6">
