        ...
        <div class="col-12">          
          ...
          <div class="box box-solid bg-dark2">
            <div class="box-header">
              <h5 class="box-title">Form Tambah Kategori Artikel</h5>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php base_url('page/admin/kategori/tambah') ?>" method="post" enctype="multipart/form-data">
              

             <div class="form-group">
                            <h5>Nama Kategori <span class="text-danger">*</span></h5>
                  <input type="text" name="kategori" class="form-control <?php echo form_error('kategori') ? 'is-invalid':'' ?>">
