  ...
  <div class="content-header">
    <div class="d-flex align-items-center">
      ...
      <a href="<?php echo site_url();?>page/admin/agenda/tambah" type="button" class="btn btn-outline btn-rounded btn-primary mb-5"><i class="fa fa-plus"></i> Tambah Agenda</a>
      </div>
    </div>
          ...
          <center>-</center>
           <?php }else{ ?>
                ...
                <?php } ?>
                 ...
                 <a href="<?php echo site_url('page/admin/agenda/edit/'.$agenda->id_agenda) ?>" data-toggle="tooltip" class="btn btn-info btn-wth-icon icon-wthot-bg btn-sm" data-original-title="Edit"><span class="icon-label"><i class="fa fa-pencil"></i> </span><span class="btn-text"></span></a>
                 <a onclick="deleteConfirm('<?php echo site_url('page/admin/agenda/delete/'.$agenda->id_agenda) ?>')" href="#!" data-toggle="tooltip" class="btn btn-danger btn-wth-icon icon-wthot-bg btn-sm" data-original-title="Hapus"><span class="icon-label" data-toggle="modal" data-target="#modal-danger"><i class="fa fa-trash"></i> </span><span class="btn-text"></span></a>
                 </td>
            </tr>
          <?php endforeach; ?>
          </tbody>
