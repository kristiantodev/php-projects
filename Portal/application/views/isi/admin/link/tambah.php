        ...
        <div class="col-12">          
          ...
          <div class="box box-solid bg-dark2">
            <div class="box-header">
              <h5 class="box-title">Form Tambah Link Eksternal</h5>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php base_url('page/admin/link/tambah') ?>" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-6">
                  <h5>Nama Link <span class="text-danger">*</span></h5>
                  <input type="text" name="nama_link" class="form-control <?php echo form_error('nama_link') ? 'is-invalid':'' ?>">
          ...
          <label for="radio_39">Link Eksternal</label>
             ...
             <div class="form-group">
                  ...
                  <input type="text" name="url" class="form-control <?php echo form_error('url') ? 'is-invalid':'' ?>">
