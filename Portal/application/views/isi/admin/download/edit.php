  ...
  <div class="content-header">
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">          
          ...
          <div class="box box-solid bg-dark2">
            <div class="box-header">
              <h5 class="box-title">Form Edit Download</h5>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php base_url('page/dosen/download/edit') ?>" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" value="<?php echo $download->nm_download?>" name="nm_download" class="form-control <?php echo form_error('nm_download') ? 'is-invalid':'' ?>"> </div>
        ...
        <input type="hidden" name="old_image" value="<?php echo $download->file?>"/>
                        <hr>
                        <p align="right">
