  ...
  <div class="content-header">
    <div class="d-flex align-items-center">
      ...
      <a href="<?php echo site_url();?>page/admin/artikel/tambah" type="button" class="btn btn-outline btn-rounded btn-primary mb-5"><i class="fa fa-send"></i>&nbsp;&nbsp; Post Artikel</a>
      </div>
    </div>
         ...
         foreach ($artikelku as $artikel): ?>
            <tr>
                ...
                <?php } ?>
                     ...
                     <td align="center">
                     <a href="<?php echo site_url('page/admin/artikel/edit/'.$artikel->id_artikel) ?>" data-toggle="tooltip" class="btn btn-info btn-wth-icon icon-wthot-bg btn-sm" data-original-title="Edit"><span class="icon-label"><i class="fa fa-pencil"></i> </span><span class="btn-text"></span></a>
                     <a onclick="deleteConfirm('<?php echo site_url('page/admin/artikel/delete/'.$artikel->id_artikel) ?>')" href="#!" data-toggle="tooltip" class="btn btn-danger btn-wth-icon icon-wthot-bg btn-sm" data-original-title="Hapus"><span class="icon-label" data-toggle="modal" data-target="#modal-danger"><i class="fa fa-trash"></i> </span><span class="btn-text"></span></a>
