        ...
        <div class="col-12">          
          ...
          <div class="box box-solid bg-dark2">
            <div class="box-header">
              <h5 class="box-title">Form Tambah Kerjasama</h5>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php base_url('page/admin/kerjasama/tambah') ?>" method="post" enctype="multipart/form-data">
              <div class="form-group">
                            <h5>Nama Perusahaan <span class="text-danger">*</span></h5>
                            <div class="controls">
                                <input type="text" name="nm_perusahaan" class="form-control <?php echo form_error('nm_perusahaan') ? 'is-invalid':'' ?>"> </div>
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" name="thn_mulai" class="form-control">
                </div>

                <div class="col-md-6">
                  <h5>Tahun Berakhir <span class="text-danger">* </span></h5>
                  <input type="number" name="thn_berakhir" class="form-control">
                 <br>
                </div>
                </div>
