        ...
        <div class="col-12">          
          ...
          <div class="box box-solid bg-dark2">
            <div class="box-header">
              <h5 class="box-title">Form Tambah Slider</h5>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php base_url('page/admin/slider/tambah') ?>" method="post" enctype="multipart/form-data">
             
                         <div class="form-group">
                            <h5>Slider<span class="text-danger">*</span></h5>
                            <div class="controls">
                         ...
                         <div class="form-group">
                            ...
                            <div class="controls">
                               <textarea name="keterangan" id="editor1" class="form-control <?php echo form_error('nm_album') ? 'is-invalid':'' ?>"></textarea>
