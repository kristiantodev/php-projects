      ...
      <div class="row">
        <div class="col-12">          
          ...
          <div class="box box-solid bg-dark2">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php base_url('page/kaprodi/gallery/edit') ?>" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id_gallery" value="<?php echo $gallery->id_gallery?>"/>
              <center><img src="<?php echo base_url('assets/images/gallery/'.$gallery->foto) ?>" width='300' height='200' alt=""></center>
