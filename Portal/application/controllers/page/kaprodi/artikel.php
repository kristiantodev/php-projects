...
public function __construct()
    {
        ...
        $this->load->model("kaprodi/artikel_model", "My_model");
	...
	public function index()
	{
        $data["title"] = "Artikel & Berita";
		 ...
		 $this->page_data('isi/kaprodi/artikel/artikel',$data);
  ...
  public function tambah()
  {
        ...
        if ($validation->run()) {
            ...
            if($upload_image){
              ...
              if ($this->upload->do_upload('foto')) {
                 ...
                 redirect(site_url('page/kaprodi/artikel/')); 
     ...
     $this->page_form('isi/kaprodi/artikel/tambah',$data);
  ...
  public function edit($id = null)
    {
        if (!isset($id)) redirect('page/kaprodi/artikel/');
        ...
        $this->page_form('isi/kaprodi/artikel/edit',$data);
