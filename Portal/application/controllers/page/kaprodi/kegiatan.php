...
public function __construct()
    {
        ...
        $this->load->model("kaprodi/kegiatan_model", "My_model");
	...
	public function index()
	{
        $data["title"] = "Kegiatan";
		 ...
		 $this->page_data('isi/kaprodi/kegiatan/kegiatan',$data);
  ...
  public function tambah()
  {
        ...
        if ($validation->run()) {
            ...
            if($upload_image){
              ...
              if ($this->upload->do_upload('foto')) {
                 ...
                 redirect(site_url('page/kaprodi/kegiatan/')); 
     ...
     $this->page_form('isi/kaprodi/kegiatan/tambah',$data);
  ...
  public function edit($id = null)
    {
        if (!isset($id)) redirect('page/kaprodi/kegiatan/');
        ...
        $this->page_form('isi/kaprodi/kegiatan/edit',$data);
