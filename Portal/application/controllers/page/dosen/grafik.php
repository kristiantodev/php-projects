...
public function __construct()
	...
	{
         foreach($this->statistik_model->statistik_pengunjung4()->result_array() as $row)
   {
    ...
    $data['grafik'][]=(float)$row['Desember3'];
         ...
         $data["title"] = "Grafik Kunjungan My Blog Harian";
         $this->page_grafik('isi/grafik2',$data);
    ...
    public function lihat()
    {
         ...
         foreach($this->statistik_model->statistik_filter2($b, $tahun)->result_array() as $row)
   {
    $data['grafik'][]=(float)$row['Januari'];
    $data['grafik'][]=(float)$row['Februari'];
    $data['grafik'][]=(float)$row['Maret'];
    ...
    $data['grafik'][]=(float)$row['Desember3'];
         ...
         $data['y'] = $tahun;
         $data["title"] = "Grafik Kunjungan My Blog Harian";
         $this->page_grafik('isi/grafik_filter2',$data);
