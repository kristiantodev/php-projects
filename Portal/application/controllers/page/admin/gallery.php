...
public function __construct()
	...
	public function index()
	{
		 ...
		 $data["title"] = "Gallery";
		 $this->page_data('isi/admin/gallery/gallery',$data);
  ...
  public function tambah()
  {
           ...
           $id = rand();
            ...
            if($upload_image){
              ...
              if ($this->upload->do_upload('foto')) {
                 ...
                 redirect(site_url('page/admin/gallery/')); 
     ...
     $this->page_form('isi/admin/gallery/tambah',$data);
  ...
  public function edit($id = null)
    {
        if (!isset($id)) redirect('page/admin/gallery/');
     ...
     $this->page_form('isi/admin/gallery/edit',$data);
