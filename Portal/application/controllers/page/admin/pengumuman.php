...
public function __construct()
    {
        ...
        $this->load->model("admin/pengumuman_model", "My_model");
	...
	public function index()
	{
        $data["title"] = "Pengumuman";
		 ...
		 $this->page_data('isi/admin/pengumuman/pengumuman',$data);
  ...
  public function tambah()
  {
     ...
     $this->page_form('isi/admin/pengumuman/tambah',$data);
  ...
  public function edit($id = null)
    {
        if (!isset($id)) redirect('page/admin/pengumuman/');
        ...
        $this->page_form('isi/admin/pengumuman/edit',$data);
